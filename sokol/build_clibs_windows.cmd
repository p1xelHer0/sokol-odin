...
REM set sources=log app gfx glue time audio debugtext shape gl
set sources=log app gfx glue gl
...
REM     cl /c /D_DEBUG /DIMPL /DSOKOL_GLCORE c\sokol_%%s.c /Z7
REM     lib /OUT:%%s\sokol_%%s_windows_x64_gl_debug.lib sokol_%%s.obj
...
REM REM GL Debug DLL
REM cl /D_DEBUG /DIMPL /DSOKOL_DLL /DSOKOL_GLCORE c\sokol.c /Z7 /LDd /MDd /DLL /Fe:sokol_dll_windows_x64_gl_debug.dll /link /INCREMENTAL:NO
REM
